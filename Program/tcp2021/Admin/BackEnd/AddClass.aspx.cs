...
public partial class Admin_BackEnd_AddClass : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            cdb._C_Name = name;
            cdb._C_EmbedCode = Common.Encrypt(Server.UrlDecode(embedcode));
            cdb._C_TeacherName = teachername;
            cdb._C_OpenDate = opdate;
            cdb._C_CloseDate = csdate;
            cdb._C_Sort = sort;
            cdb._C_Status = status;
            cdb._C_CreateId = LogInfo.mGuid;
            cdb._C_ModId = LogInfo.mGuid;

            if (mode == "new")
            {
                cdb._C_Guid = tmpGuid;
                cdb.addClass(oConn, myTrans);
            }
            else
            {
                cdb._C_Guid = tmpGuid;
                cdb.UpdateClass(oConn, myTrans);
            }
