<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="assignmentview1.aspx.cs" Inherits="WebPage_assignmentview" %>
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        if ($(data).find("Error").length > 0) {
                            ...
                            location.href = "assignmentview1.aspx?guid=" + $.getQueryString("guid");
                        }
                    }
                });
            });
            ...
            $(".submenuselect").on("change", function () {
                ...
                switch (selection) {
                    ...
                    case "513":
                        ...
                        break;
                    case "600":
                        $('#goto600').animatescroll({ scrollSpeed: 1000, padding: 0 });
                        defval();
                        return false;
                        break;
                    case "602":
                        $('#goto602').animatescroll({ scrollSpeed: 1000, padding: 0 });
                        defval();
                        return false;
                        break;
                    case "603":
                        $('#goto603').animatescroll({ scrollSpeed: 1000, padding: 0 });
                        defval();
                        return false;
                        break;
                    case "604":
                        $('#goto604').animatescroll({ scrollSpeed: 1000, padding: 0 });
                        defval();
                        return false;
                        break;
                    case "605":
                        $('#goto605').animatescroll({ scrollSpeed: 1000, padding: 0 });
                        defval();
                        return false;
                        break;
                    case "999":
                        ...
                        <div id="tabs1">
                            ...
                            <div class="margin5T textright">
                                <select class="submenuselect inputex font-size1" style="width: 100px;">
                                    ...
                                    <option value="600">6.0 Essential Principles Applicable to Medical Devices other than IVD Medical Devices</option>
                                    <option value="602">6.2 Protection against Radiation</option>
                                    <option value="603">6.3 Particular Requirements for Implantable Medical Devices</option>
                                    <option value="604">6.4 Protection against the Risks Posed to the Patient or User by Medical Devices Supplying Energy or Substances</option>
                                    <option value="605">6.5 Medical Devices Incorporating a Substance Considered to be a Medicinal Product/Drug</option>
                                    <option value="999">END</option>
                                </select>
                                <a href="<%= ResolveUrl("~/doc/Assignment1_0825.zip") %>" target="_blank" class="genbtnS">Download</a>
                            </div>
                            ...
                            <div id="goto600" class="font-size3 font-black font-bold margin20T">
                            ...
                            <div>
                                ...
                                <div class="BoxRadiusAd BoxBorderSa BoxBgWc padding10ALL">
                                    <div class="tableStyle width100">
                                        <div class="trStyle">
                                            <div class="tdStyle width50">
                                                <span class="font-title">Applicability:</span>
                                                <input name="rda_6_1_1" value="Y" type="radio">
                                                Yes
                                    <input name="rda_6_1_1" value="N" type="radio">
                                                No
                                            </div>
                                            <div class="tdStyle">
                                                <span class="font-title">Sharing my answer:</span>
                                                <input name="rds_6_1_1" value="Y" type="radio">
                                                Yes
                                    <input name="rds_6_1_1" value="N" type="radio">
                                                No
                                            </div>
                                        </div>
                                    </div>
                                    <div class="tableStyle width100 margin5T">
                                        <div class="trStyle">
                                            <div class="tdStyle">
                                                <input name="txtrs_6_1_1" type="text" class="inputex width100" placeholder="Relevant Standards">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="tableStyle width100 margin5T">
                                        <div class="trStyle">
                                            <div class="tdStyle">
                                                <textarea name="txtjf_6_1_1" rows="3" cols="" class="inputex width100" placeholder="Justification(optional)"></textarea>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="sharingansbtn">Show sharing answer</div>
                                    <div class="sharinganstb stripeMeCS margin5T">
                                        <table id="tablist_6_1_1" width="100%">
                                            <thead>
                                                <tr>
                                                    <th>User</th>
                                                    <th width="100">Applicability</th>
                                ...
                                <div class="BoxRadiusAd BoxBorderSa BoxBgWc padding10ALL">
                                    <div class="tableStyle width100">
                                        <div class="trStyle">
                                            <div class="tdStyle width50">
                                                <span class="font-title">Applicability:</span>
                                                <input name="rda_6_1_2" value="Y" type="radio">
                                                Yes
                                    <input name="rda_6_1_2" value="N" type="radio">
                                                No
                                            </div>
                                            <div class="tdStyle">
                                                <span class="font-title">Sharing my answer:</span>
                                                <input name="rds_6_1_2" value="Y" type="radio">
                                                Yes
                                    <input name="rds_6_1_2" value="N" type="radio">
                                                No
                                            </div>
                                        </div>
                                    </div>
                                    <div class="tableStyle width100 margin5T">
                                        <div class="trStyle">
                                            <div class="tdStyle">
                                                <input name="txtrs_6_1_2" type="text" class="inputex width100" placeholder="Relevant Standards">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="tableStyle width100 margin5T">
                                        <div class="trStyle">
                                            <div class="tdStyle">
                                                <textarea name="txtjf_6_1_2" rows="3" cols="" class="inputex width100" placeholder="Justification(optional)"></textarea>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="sharingansbtn">Show sharing answer</div>
                                    <div class="sharinganstb stripeMeCS margin5T">
                                        <table id="tablist_6_1_2" width="100%">
                                            <thead>
                                                <tr>
                                                    <th>User</th>
                                                    <th width="100">Applicability</th>
                                ...
                                <!-- in start -->
                                <div class="BoxRadiusAu BoxBorderSa padding10ALL margin10T">
                                    6.1.3 Medical devices should be designed and manufactured in such a way as to appropriately reduce the risks linked to the size and the properties of particles which are or can be released into the patient's or user's body, unless they come into contact with intact skin only. Special attention should be given to nanomaterials.
                                </div>
                                <!-- BoxRadiusAu -->
                                <div class="BoxRadiusAd BoxBorderSa BoxBgWc padding10ALL">
                                    <div class="tableStyle width100">
                                        <div class="trStyle">
                                            <div class="tdStyle width50">
                                                <span class="font-title">Applicability:</span>
                                                <input name="rda_6_1_3" value="Y" type="radio">
                                                Yes
                                    <input name="rda_6_1_3" value="N" type="radio">
                                                No
                                            </div>
                                            <div class="tdStyle">
                                                <span class="font-title">Sharing my answer:</span>
                                                <input name="rds_6_1_3" value="Y" type="radio">
                                                Yes
                                    <input name="rds_6_1_3" value="N" type="radio">
                                                No
                                            </div>
                                        </div>
                                    </div>
                                    <div class="tableStyle width100 margin5T">
                                        <div class="trStyle">
                                            <div class="tdStyle">
                                                <input name="txtrs_6_1_3" type="text" class="inputex width100" placeholder="Relevant Standards">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="tableStyle width100 margin5T">
                                        <div class="trStyle">
                                            <div class="tdStyle">
                                                <textarea name="txtjf_6_1_3" rows="3" cols="" class="inputex width100" placeholder="Justification(optional)"></textarea>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="sharingansbtn">Show sharing answer</div>
                                    <div class="sharinganstb stripeMeCS margin5T">
                                        <table id="tablist_6_1_3" width="100%">
                                            <thead>
                                                <tr>
                                                    <th>User</th>
                                                    <th width="100">Applicability</th>
                            ...
                            <div id="goto602" class="font-size3 font-black font-bold margin20T">
                                6.2 Protection against Radiation
                            </div>
                            <!-- 6.2 start -->
                            <div>
                                ...
                                <!-- in start -->
                                <div class="BoxRadiusAu BoxBorderSa padding10ALL margin10T">
                                    6.2.1 Medical devices emitting ionizing radiation intended for medical imaging should be designed and manufactured in such a way as to achieve an image and/or output quality that are appropriate to the intended medical purpose whilst minimizing radiation exposure of the patient, user, and other persons.
                                </div>
                                <!-- BoxRadiusAu -->
                                <div class="BoxRadiusAd BoxBorderSa BoxBgWc padding10ALL">
                                    <div class="tableStyle width100">
                                        <div class="trStyle">
                                            <div class="tdStyle width50">
                                                <span class="font-title">Applicability:</span>
                                                <input name="rda_6_2_1" value="Y" type="radio">
                                                Yes
                                    <input name="rda_6_2_1" value="N" type="radio">
                                                No
                                            </div>
                                            <div class="tdStyle">
                                                <span class="font-title">Sharing my answer:</span>
                                                <input name="rds_6_2_1" value="Y" type="radio">
                                                Yes
                                    <input name="rds_6_2_1" value="N" type="radio">
                                                No
                                            </div>
                                        </div>
                                    </div>
                                    <div class="tableStyle width100 margin5T">
                                        <div class="trStyle">
                                            <div class="tdStyle">
                                                <input name="txtrs_6_2_1" type="text" class="inputex width100" placeholder="Relevant Standards">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="tableStyle width100 margin5T">
                                        <div class="trStyle">
                                            <div class="tdStyle">
                                                <textarea name="txtjf_6_2_1" rows="3" cols="" class="inputex width100" placeholder="Justification(optional)"></textarea>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="sharingansbtn">Show sharing answer</div>
                                    <div class="sharinganstb stripeMeCS margin5T">
                                        <table id="tablist_6_2_1" width="100%">
                                            <thead>
                                                <tr>
                                                    <th>User</th>
                                                    <th width="100">Applicability</th>
                                ...
                                <!-- in start -->
                                <div class="BoxRadiusAu BoxBorderSa padding10ALL margin10T">
                                    6.2.2 Medical devices emitting ionizing radiation should be designed to allow the accurate estimation (or monitoring), display, reporting, and recording of the dose from a treatment.
                                </div>
                                <!-- BoxRadiusAu -->
                                <div class="BoxRadiusAd BoxBorderSa BoxBgWc padding10ALL">
                                    <div class="tableStyle width100">
                                        <div class="trStyle">
                                            <div class="tdStyle width50">
                                                <span class="font-title">Applicability:</span>
                                                <input name="rda_6_2_2" value="Y" type="radio">
                                                Yes
                                    <input name="rda_6_2_2" value="N" type="radio">
                                                No
                                            </div>
                                            <div class="tdStyle">
                                                <span class="font-title">Sharing my answer:</span>
                                                <input name="rds_6_2_2" value="Y" type="radio">
                                                Yes
                                    <input name="rds_6_2_2" value="N" type="radio">
                                                No
                                            </div>
                                        </div>
                                    </div>
                                    <div class="tableStyle width100 margin5T">
                                        <div class="trStyle">
                                            <div class="tdStyle">
                                                <input name="txtrs_6_2_2" type="text" class="inputex width100" placeholder="Relevant Standards">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="tableStyle width100 margin5T">
                                        <div class="trStyle">
                                            <div class="tdStyle">
                                                <textarea name="txtjf_6_2_2" rows="3" cols="" class="inputex width100" placeholder="Justification(optional)"></textarea>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="sharingansbtn">Show sharing answer</div>
                                    <div class="sharinganstb stripeMeCS margin5T">
                                        <table id="tablist_6_2_2" width="100%">
                                            <thead>
                                                <tr>
                                                    <th>User</th>
                                                    <th width="100">Applicability</th>
                            ...
                            <div id="goto603" class="font-size3 font-black font-bold margin20T">
                                6.3 Particular Requirements for Implantable Medical Devices
                            </div>
                            <!-- 6.3 start -->
                            <div>
                                ...
                                <!-- in start -->
                                <div class="BoxRadiusAu BoxBorderSa padding10ALL margin10T">
                                    6.3.1 Implantable medical devices should be designed and manufactured in such a way as to remove or appropriately reduce the risks associated with medical treatment, e.g. the use of defibrillators, high-frequency surgical equipment.
                                </div>
                                <!-- BoxRadiusAu -->
                                <div class="BoxRadiusAd BoxBorderSa BoxBgWc padding10ALL">
                                    <div class="tableStyle width100">
                                        <div class="trStyle">
                                            <div class="tdStyle width50">
                                                <span class="font-title">Applicability:</span>
                                                <input name="rda_6_3_1" value="Y" type="radio">
                                                Yes
                                    <input name="rda_6_3_1" value="N" type="radio">
                                                No
                                            </div>
                                            <div class="tdStyle">
                                                <span class="font-title">Sharing my answer:</span>
                                                <input name="rds_6_3_1" value="Y" type="radio">
                                                Yes
                                    <input name="rds_6_3_1" value="N" type="radio">
                                                No
                                            </div>
                                        </div>
                                    </div>
                                    <div class="tableStyle width100 margin5T">
                                        <div class="trStyle">
                                            <div class="tdStyle">
                                                <input name="txtrs_6_3_1" type="text" class="inputex width100" placeholder="Relevant Standards">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="tableStyle width100 margin5T">
                                        <div class="trStyle">
                                            <div class="tdStyle">
                                                <textarea name="txtjf_6_3_1" rows="3" cols="" class="inputex width100" placeholder="Justification(optional)"></textarea>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="sharingansbtn">Show sharing answer</div>
                                    <div class="sharinganstb stripeMeCS margin5T">
                                        <table id="tablist_6_3_1" width="100%">
                                            <thead>
                                                <tr>
                                                    <th>User</th>
                                                    <th width="100">Applicability</th>
                                ...
                                <!-- in start -->
                                <div class="BoxRadiusAu BoxBorderSa padding10ALL margin10T">
                                    6.3.2 Active programmable implantable medical devices should be designed and manufactured in a manner that allows the unequivocal identification of the device without the need for a surgical operation.
                                </div>
                                <!-- BoxRadiusAu -->
                                <div class="BoxRadiusAd BoxBorderSa BoxBgWc padding10ALL">
                                    <div class="tableStyle width100">
                                        <div class="trStyle">
                                            <div class="tdStyle width50">
                                                <span class="font-title">Applicability:</span>
                                                <input name="rda_6_3_2" value="Y" type="radio">
                                                Yes
                                    <input name="rda_6_3_2" value="N" type="radio">
                                                No
                                            </div>
                                            <div class="tdStyle">
                                                <span class="font-title">Sharing my answer:</span>
                                                <input name="rds_6_3_2" value="Y" type="radio">
                                                Yes
                                    <input name="rds_6_3_2" value="N" type="radio">
                                                No
                                            </div>
                                        </div>
                                    </div>
                                    <div class="tableStyle width100 margin5T">
                                        <div class="trStyle">
                                            <div class="tdStyle">
                                                <input name="txtrs_6_3_2" type="text" class="inputex width100" placeholder="Relevant Standards">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="tableStyle width100 margin5T">
                                        <div class="trStyle">
                                            <div class="tdStyle">
                                                <textarea name="txtjf_6_3_2" rows="3" cols="" class="inputex width100" placeholder="Justification(optional)"></textarea>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="sharingansbtn">Show sharing answer</div>
                                    <div class="sharinganstb stripeMeCS margin5T">
                                        <table id="tablist_6_3_2" width="100%">
                                            <thead>
                                                <tr>
                                                    <th>User</th>
                                                    <th width="100">Applicability</th>
                            ...
                            <div id="goto604" class="font-size3 font-black font-bold margin20T">
                                6.4 Protection against the Risks Posed to the Patient or User by Medical Devices Supplying Energy or Substances
                            </div>
                            <!-- 6.4 start -->
                            <div>
                                ...
                                <!-- in start -->
                                <div class="BoxRadiusAu BoxBorderSa padding10ALL margin10T">
                                    6.4.1 Medical devices for supplying the patient with energy or substances should be designed and manufactured in such a way that the amount to be delivered can be set and maintained accurately enough to ensure the safety of the patient, user, and others.
                                </div>
                                <!-- BoxRadiusAu -->
                                <div class="BoxRadiusAd BoxBorderSa BoxBgWc padding10ALL">
                                    <div class="tableStyle width100">
                                        <div class="trStyle">
                                            <div class="tdStyle width50">
                                                <span class="font-title">Applicability:</span>
                                                <input name="rda_6_4_1" value="Y" type="radio">
                                                Yes
                                    <input name="rda_6_4_1" value="N" type="radio">
                                                No
                                            </div>
                                            <div class="tdStyle">
                                                <span class="font-title">Sharing my answer:</span>
                                                <input name="rds_6_4_1" value="Y" type="radio">
                                                Yes
                                    <input name="rds_6_4_1" value="N" type="radio">
                                                No
                                            </div>
                                        </div>
                                    </div>
                                    <div class="tableStyle width100 margin5T">
                                        <div class="trStyle">
                                            <div class="tdStyle">
                                                <input name="txtrs_6_4_1" type="text" class="inputex width100" placeholder="Relevant Standards">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="tableStyle width100 margin5T">
                                        <div class="trStyle">
                                            <div class="tdStyle">
                                                <textarea name="txtjf_6_4_1" rows="3" cols="" class="inputex width100" placeholder="Justification(optional)"></textarea>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="sharingansbtn">Show sharing answer</div>
                                    <div class="sharinganstb stripeMeCS margin5T">
                                        <table id="tablist_6_4_1" width="100%">
                                            <thead>
                                                <tr>
                                                    <th>User</th>
                                                    <th width="100">Applicability</th>
                                ...
                                <!-- in start -->
                                <div class="BoxRadiusAu BoxBorderSa padding10ALL margin10T">
                                    6.4.2 Medical devices should be fitted with the means of preventing and/or indicating any inadequacies in the amount of energy delivered or substances delivered which could pose a danger. Devices should incorporate suitable means to appropriately reduce the risk of accidental release of dangerous levels of energy or substances from an energy and/or substance source.
                                </div>
                                <!-- BoxRadiusAu -->
                                <div class="BoxRadiusAd BoxBorderSa BoxBgWc padding10ALL">
                                    <div class="tableStyle width100">
                                        <div class="trStyle">
                                            <div class="tdStyle width50">
                                                <span class="font-title">Applicability:</span>
                                                <input name="rda_6_4_2" value="Y" type="radio">
                                                Yes
                                    <input name="rda_6_4_2" value="N" type="radio">
                                                No
                                            </div>
                                            <div class="tdStyle">
                                                <span class="font-title">Sharing my answer:</span>
                                                <input name="rds_6_4_2" value="Y" type="radio">
                                                Yes
                                    <input name="rds_6_4_2" value="N" type="radio">
                                                No
                                            </div>
                                        </div>
                                    </div>
                                    <div class="tableStyle width100 margin5T">
                                        <div class="trStyle">
                                            <div class="tdStyle">
                                                <input name="txtrs_6_4_2" type="text" class="inputex width100" placeholder="Relevant Standards">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="tableStyle width100 margin5T">
                                        <div class="trStyle">
                                            <div class="tdStyle">
                                                <textarea name="txtjf_6_4_2" rows="3" cols="" class="inputex width100" placeholder="Justification(optional)"></textarea>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="sharingansbtn">Show sharing answer</div>
                                    <div class="sharinganstb stripeMeCS margin5T">
                                        <table id="tablist_6_4_2" width="100%">
                                            <thead>
                                                <tr>
                                                    <th>User</th>
                                                    <th width="100">Applicability</th>
                            ...
                            <div id="goto605" class="font-size3 font-black font-bold margin20T">
                                6.5 Medical Devices Incorporating a Substance Considered to be a Medicinal Product/Drug
                            </div>
                            <!-- 6.5 start -->
                            <div>
                                ...
                                <!-- in start -->
                                <div class="BoxRadiusAu BoxBorderSa padding10ALL margin10T">
                                    6.5.1 Where a medical device incorporates, as an integral part, a substance which, if used separately may be considered to be a medicinal product/drug as defined in the relevant legislation that applies in that Regulatory Authority and which is liable to act upon the body with action ancillary to that of the medical device, the safety and performance of the medical device as a whole should be verified, as well as the identity, safety, quality and efficacy of the substance in the specific combination product.
                                </div>
                                <!-- BoxRadiusAu -->
                                <div class="BoxRadiusAd BoxBorderSa BoxBgWc padding10ALL">
                                    <div class="tableStyle width100">
                                        <div class="trStyle">
                                            <div class="tdStyle width50">
                                                <span class="font-title">Applicability:</span>
                                                <input name="rda_6_5_1" value="Y" type="radio">
                                                Yes
                                    <input name="rda_6_5_1" value="N" type="radio">
                                                No
                                            </div>
                                            <div class="tdStyle">
                                                <span class="font-title">Sharing my answer:</span>
                                                <input name="rds_6_5_1" value="Y" type="radio">
                                                Yes
                                    <input name="rds_6_5_1" value="N" type="radio">
                                                No
                                            </div>
                                        </div>
                                    </div>
                                    <div class="tableStyle width100 margin5T">
                                        <div class="trStyle">
                                            <div class="tdStyle">
                                                <input name="txtrs_6_5_1" type="text" class="inputex width100" placeholder="Relevant Standards">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="tableStyle width100 margin5T">
                                        <div class="trStyle">
                                            <div class="tdStyle">
                                                <textarea name="txtjf_6_5_1" rows="3" cols="" class="inputex width100" placeholder="Justification(optional)"></textarea>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="sharingansbtn">Show sharing answer</div>
                                    <div class="sharinganstb stripeMeCS margin5T">
                                        <table id="tablist_6_5_1" width="100%">
                                            <thead>
                                                <tr>
                                                    <th>User</th>
                                                    <th width="100">Applicability</th>
