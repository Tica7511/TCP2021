<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPageOther.master" AutoEventWireup="true" CodeFile="otherclassview.aspx.cs" Inherits="WebPage_otherclassview" %>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            if ($.getQueryString("guid") != '') {
                ...
                location.href = "otherclasslist.aspx";
            }
                        ...
                        if ($(data).find("data_item").length > 0) {
                            $(data).find("data_item").each(function (i) {
                                if ($(this).children("MC_IsFinish").text().trim() == 'Y')
                                    $("#sp_isFinish").show();
                                $("#div_classname").append($(this).children("OC_Name").text().trim());
                                $("#div_embedcode").append($(this).children("EncodeEmbedCode").text().trim());
                                $("#div_teachername").append('<i class="fa fa-user-circle-o IconCa" aria-hidden="true"></i> ' + $(this).children("OC_TeacherName").text().trim());
                            });
                        }
    ...
    <div class="container margin15T">
        <div id="Insidemaincontent">
            ...
            <div class="paddingMVRL">
                ...
                <div class="margin10T BoxBorderSa BoxRadiusB padding10ALL">

                    <div id="div_classname" class="font-size4 font-title"></div>

                    <div id="div_embedcode" class="embed-container margin10T"></div>

                    <div class="twocol margin10T">
                        <div id="div_teachername" class="left">
                        </div>
